...
function api_transacao_get($request) {
  // Por padrão as transações retornadas ao usuário em um GET será as suas compras, a não ser que ele torne explícito que quer suas vendas passando o parametro vendedor_id na url
